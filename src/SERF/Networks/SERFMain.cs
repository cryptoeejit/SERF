...
using SERF.Networks.Policies;
using SERF.Networks.Rules;
using NBitcoin;
...
using SERF.Networks.Deployments;
...
namespace SERF.Networks
{
   public class SERFMain : Network
   {
      public SERFMain()
      {
         ...
         DefaultConfigFilename = setup.ConfigFileName; // The default name used for the SERF configuration file.
         ...
         {
            [SERFBIP9Deployments.ColdStaking] = new BIP9DeploymentsParameters("ColdStaking", 2,
         ...
         Consensus.PosEmptyCoinbase = SERFSetup.Instance.IsPoSv3();
         Consensus.PosUseTimeFieldInKernalHash = SERFSetup.Instance.IsPoSv3();
         ...
         StandardScriptsRegistry = new SERFStandardScriptsRegistry();
